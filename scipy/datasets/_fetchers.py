...
from numpy import array, frombuffer, load, genfromtxt
from .utils import _has_hash
from ._registry import data_repo_map, registry, registry_urls
import os
...
def iris():
    """
    Load the iris sample data.
    """
    fname = data.fetch("iris.csv")
    iris = genfromtxt(fname, delimiter=',')
    return iris
